...
export class WebCPU {
    ...
    static __wrap(ptr) {
        const obj = Object.create(WebCPU.prototype);
        obj.ptr = ptr;
    ...
    */
    tick() {
        wasm.webcpu_tick(this.ptr);
    }
    /**
    */
    tick_timers() {
        wasm.webcpu_tick_timers(this.ptr);
    }
    /**
    */
    reset() {
        wasm.webcpu_reset(this.ptr);
    }
    /**
    * @param {KeyboardEvent} evt
    * @param {boolean} b_pressed
    */
    keypress(evt, b_pressed) {
        wasm.webcpu_keypress(this.ptr, addHeapObject(evt), b_pressed);
    }
    /**
    * @param {Uint8Array} data
    */
    load_game(data) {
        wasm.webcpu_load_game(this.ptr, addHeapObject(data));
    }
    /**
    * @param {number} scale
    */
    draw_screen(scale) {
        wasm.webcpu_draw_screen(this.ptr, scale);
    }
}
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('chip8_facade_bg.wasm', import.meta.url);
    }
    const imports = getImports();
